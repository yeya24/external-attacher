...
- Promote MutableCSINodeAllocatableCount feature to GA. ([#695](https://github.com/kubernetes-csi/external-attacher/pull/695), [@torredil](https://github.com/torredil))

### Other (Cleanup or Flake)

- Bump k8s dependencies to v1.36.1 ([#721](https://github.com/kubernetes-csi/external-attacher/pull/721), [@dfajmon](https://github.com/dfajmon))
